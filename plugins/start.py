...
async def start_command(client: Client, message: Message):
    ...
    if user_id in await db.get_all_admins():
        ...
        if SHORTLINK_URL or SHORTLINK_API:
            ...
            if not verify_status['is_verified'] and not is_premium:
                token = ''.join(random.choices(mrghosts.ascii_letters + mrghosts.digits, k=10))
    ...
    if len(text) > 7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/webversehub")],
            ...
            if not await is_sub(client, user_id, chat_id):
                try:
                    ...
                    return await temp.edit(
                        f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @mrghosts_1888</i></b>\n"
