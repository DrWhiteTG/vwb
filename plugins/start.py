    ...
    if len(text) > 7:
        ...
        for msg in messages:
            ...
            try:
                ...
                mrghosts_msgs.append(copied_msg)
            except:
                pass
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/AboutShreyansh")],
...
#=====================================================================================##
# Don't Remove Credit @MrGhostsx, @Tech_Shreyansh29
# Ask Doubt on telegram @ShreyanshSupport2
