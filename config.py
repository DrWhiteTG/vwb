...
OWNER_ID = int(os.environ.get("OWNER_ID", "6910445402")) # Owner id
#--------------------------------------------
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @SmartEdith_Bot</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
